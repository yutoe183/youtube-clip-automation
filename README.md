...
- `src/font/MPLUSRounded1c-Regular.ttf` : 日本語対応のフォントです。
- `src/auth/cookies.txt` : ログイン情報を含むNetscape形式のCookieファイルです。ダウンロードにログイン情報が必要な場合はCookieをブラウザ等から出力して置き換えてください。
